...
if __name__ == '__main__':
    ...
    data_path = "/root/tywang/Graph_Transformer_Networks-master/"
    with open(data_path+'data/'+args.dataset+'/node_features.pkl','rb') as f:
        node_features = pickle.load(f)
    with open(data_path+'data/'+args.dataset+'/edges.pkl','rb') as f:
        edges = pickle.load(f)
    with open(data_path+'data/'+args.dataset+'/labels.pkl','rb') as f:
